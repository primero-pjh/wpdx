        ...
        let nodes = new vis.DataSet([
            ...
            { id: 0, label: "학생", shape: "square" },
                { id: 100, label: "나이스", shape: "diamond", color: 'pink' },
                    ...
                    { id: 102, label: "독서활동상황", shape: "ellipse", size: 12, color: 'green' },
                    { id: 103, label: "창의적체험활동상황", shape: "ellipse", size: 12, color: 'green' },
                    { id: 104, label: "출결상황", shape: "ellipse", size: 12, color: 'green' },
                    { id: 105, label: "수상경력", shape: "ellipse", size: 12, color: 'green' },
                    { id: 106, label: "봉사활도일적", shape: "ellipse", size: 12, color: 'green' },
                    { id: 107, label: "교과학습발달상황", shape: "ellipse", size: 12, color: 'green' },
                    { id: 108, label: "행동특성 및 종합의견", shape: "ellipse", size: 12, color: 'green' },
                ...
                { id: 200, label: "WP", shape: "diamond", color: 'pink' },   
                    ...
                    { id: 204, label: "교육 커리큘럼", shape: "ellipse", size: 12, color: 'green' },
